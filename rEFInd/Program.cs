    ...
    class Automenu : WorkClass
    {
        ...
        static void Main(string[] args)
        {
            ...
            ParserResult.WithParsed(Opt =>
            {
                ...
                {
                    ESP = (from Drive in DriveInfo.GetDrives() where File.Exists(Drive.Name + @"EFI\Microsoft\Boot\bootmgfw.efi") & Drive.DriveType == DriveType.Fixed select Drive.Name).First();
                }
                else
                {
